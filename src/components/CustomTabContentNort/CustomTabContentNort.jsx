...
const { Option } = Select;
// Đây là component nội dung của Tabs Sổ Xố Miền Bắc
function CustomTabContent() {
  ...
  return (
    <>
      ...
      <form name="" value="" action="" method="" >
      <h3 className={styles.text}>Chọn Cược Xổ Số Miền Bắc</h3>
          <Select
            mode="multiple"
            size="default"
          ...
          <p className={styles.paraph}>
            <strong>Số cược</strong> Chú ý: Vui lòng ghi ,(phẩy) giữa các số/cặp
            xiên cần cược. Ví dụ: chơi lô, đề hoặc 3 càng là{" "}
          ...
          <div className={styles.formContainer}>
            <form method="" action="" name="">
              ...
              />
              <p className={styles.paraph}>
                Số điểm (lô 1điểm=27.000đ, xem dưới..)
              </p>
              <InputNumber
                className={styles.Input}
                min={1}
        ...
        <h3 className={styles.text}>Lịch Sử Kế Qủa</h3>
          <div className={styles.box}>
            ...
            <div className={styles.title}>KQXS MIỀN BẮC</div>
            <div className={styles.overflow}>
              <table className={styles.table}>
                <thead>
                  <tr>
                ...
                <tfoot>
                  ...
                  <tr>
                    <td colSpan="2">
                      <Button type="danger" shape="round" size="large" onClick={showModal}>
...
export default React.memo(CustomTabContent);
