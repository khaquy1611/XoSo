...
import styles from "./CustomTabContentMiddle.module.css";
import { Select, Input, InputNumber, Button, Modal } from "antd";
import Tools from "../../img/tools.png";
import Print from "../../img/print.gif";
const { Option } = Select;
// Đây là component nội dung của Tabs Sổ Xố Miền Trung
function CustomTabContentMiddle() {
  ...
  return (
    <>
      <div className={styles.row}>
        ...
        <form className="" name="" value="" action="" method="">
          <div className={styles.containerSelect}>
            <h3 className={styles.text}>Chọn Cược Xổ Số Miền Trung</h3>
            <Select
              mode="multiple"
              size="default"
...
export default React.memo(CustomTabContentMiddle);
